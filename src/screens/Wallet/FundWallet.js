        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        <Header title={"Fund Wallet"} leftIcon={"ios-arrow-back"}
                        ...
                        <View style={[formStyles.auth_form, {flex: 1}]}>
                            ...
                            />
                            <Text style={styles.topHeader}>Enter Amount (₦)</Text>
                            <Text style={[formStyles.error,{bottom:scale(-10), width:'100%', position:'relative'}]}>{this.state.amount_error}</Text>
        ...
        return (
            <ButtonWithBackgroundBottom
                ...
                onPress={() => {
                    ...
                    this.props.navigation.navigate('WalletCardList', {
                        wallet,
            ...
            >
               <ButtonWithBackgroundText>{'Fund Wallet'}</ButtonWithBackgroundText>
            </ButtonWithBackgroundBottom>
        );
    };

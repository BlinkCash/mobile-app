                    ...
                    >
                        ...
                        <View  style={[formStyles.auth_form,{flex:1}]}>
                            <Text style={{
                                ...
                                textAlign: 'left'
                            }}>How much are you transfering?</Text>
        ...
        return (
            <ButtonWithBackgroundBottom
                ...
                onPress={() => {
                    ...
                    this.props.navigation.navigate('WalletSelectBanks', {
                        wallet,
            ...
            >
                <ButtonWithBackgroundText>{'Done'}</ButtonWithBackgroundText>
            </ButtonWithBackgroundBottom>
        );
    };

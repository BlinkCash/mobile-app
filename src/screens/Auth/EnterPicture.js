...
import {
    ...
    confirmBVN,
    postAddEmail,
    postVerifyBVN, postUploadFile, postAddPhoto
} from "../../lib/api/url";
...
class Login extends React.Component {
    ...
    onhandleRegister = () => {
        ...
        this.setState({
            loading: 'Saving your picture...',
            formError:''
        }, () => {
            apiRequest(postAddPhoto, 'post', {
    ...
    renderButton = () => {
        ...
        return (
            ...
            >
                ...
                <ButtonWithBackgroundText>{this.state.profileImage ? 'Continue' : 'Take a selfie'}</ButtonWithBackgroundText>
            </ButtonWithBackgroundBottom>
        );
    };
                ...
                >
                    ...
                    >
                        ...
                        <View style={[formStyles.auth_form, {flex: 1, marginTop:scale(10)}]}>
                            <Text style={styles.title}>Please take a selfie of yourself in a well lit environment</Text>
                            <Text style={[formStyles.formError]}>{this.state.formError}</Text>

                            <View style={{width: '100%', alignItems: 'center', marginVertical: scale(20)}}>
